...
string affine_decryption( string s, string a , string b, string m){
    ...
    string y_minus_b= String_Subtraction(y,b); // y- b
    string a_inv= String_Modulo_Inverse(a,m); // computing inverse of a
    string D_y =  String_Multiplication(a_inv,y_minus_b); // a_inv *(y-b)
    string D_y_mod_m= String_Modulo(D_y,m); // a_inverse(y-b) (mod m)
     decrypted+= char(stoi(D_y_mod_m)+'A');
...
int main(){
    string x ,a="987654321",b="111111",m="26";
