...
// Chosing a Mod_Base and a primitive root.
string Safe_Prime =
    "3231700607131100730071487668866995196044410266971548403213034542752465510513970940663544946400061009953925634212968748340312864603338180186583201232845547"
    "8866640049017814612630453339508537800140676854062458178866577153462154407416692817948320700932171155756949076498661479101692574856991514582183210728832907504"
    "2090917655260315101013388913134224552143936251157248146915778812870284821807170018444513424751543209344508452506312723147061327626592232262108298527438201856"
    "4037612346620576471766060589281211868572051549721520352075038855541814985919715060001583356111620029534316822120570056368765122712808350462125396031450425122"
    "3312383348143970710437173613177513666117411349983735524526394526801714528369016880127098097958314790267552363653460486692568518498559280617036307194960711674"
    "2606841051054143229655144449006254212059238890312033503230009652184505114302163879639239301281";

//Note that the primitive root is small.
string Power_Base = "2"; 
...
int main(){
    ...
    //Inputting the keys
    cin >> Key1 >> Key2;
    string Message1="1",Message2="1";

    //Calculating the messages
    Message1 = String_Modulo_Exponentiation(Power_Base,Key1,Safe_Prime);
    Message2 = String_Modulo_Exponentiation(Power_Base,Key2,Safe_Prime);
    Secret_Key = String_Modulo_Exponentiation(Message1,Key2,Safe_Prime);

    //Printing the keys
    cout << "First person chose the key \n" << Key1 <<endl;
    cout << "Second person chose the key \n" << Key2 <<endl;
    //Printing the messages
    cout<<"First person sent message \n";cout << Message1 <<endl;
    cout<<"Second person sent message \n";cout << Message2 <<endl;
    //Printing the final secret message
    cout << "Final Secret Key is \n";cout << Secret_Key;
    return 0;
}
